...
export const Media_play_button_rounded = () => {
    return (
<svg className={"shareYouTube"} viewBox={"0 0 18 18"} style={{width:"18px", height:"18px", display:"block", fill:"currentcolor", flexShrink:"0"}}>
...
export default Media_play_button_rounded
