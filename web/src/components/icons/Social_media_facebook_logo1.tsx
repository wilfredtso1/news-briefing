...
import Social_media_facebook_logo from './components/icons/Social_media_facebook_logo.tsx'

import React from 'react';

export const Social_media_facebook_logo1 = () => {
    return (
<svg className={"shareFacebook"} viewBox={"0 0 18 18"} style={{width:"18px", height:"18px", display:"block", fill:"currentcolor", flexShrink:"0"}}>
...
export default Social_media_facebook_logo1
