...
import Linkedin_logo from './components/icons/Linkedin_logo.tsx'

import React from 'react';

export const Linkedin_logo2 = () => {
    return (
<svg className={"shareLinkedIn"} viewBox={"0 0 16 16"} style={{width:"20px", height:"18px", display:"block", fill:"currentcolor", flexShrink:"0"}}>
<defs>
